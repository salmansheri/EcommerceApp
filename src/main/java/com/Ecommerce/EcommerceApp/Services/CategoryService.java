...
/**
 * Implementation of the ICategoryService interface for managing category operations. This
 * service handles CRUD operations for categories, including pagination and validation.
 */
...
public class CategoryService implements ICategoryService {
	...
	public CategoryResponseDto getAllCategories(Integer pageNumber, Integer pageSize, String sortBy, String sortOrder) {
		...
		return new CategoryResponseDto(categoryDtoList, categoryPage.getNumber(), categoryPage.getSize(),
				(int) categoryPage.getTotalElements(), categoryPage.getTotalPages(), categoryPage.isLast());
